...
class TestAggregate(unittest.TestCase):
    ...
    def test_aggregate_10x_matrices(self):
        m1 = sc.tools.read_input('tests/data/heart_1k_v3/filtered_gene_bc_matrices_h5.h5', genome='mm10',
            mode='r')
        m2 = sc.tools.read_input('tests/data/heart_1k_v2/filtered_gene_bc_matrices_h5.h5', genome='mm10',
            mode='r')
        sc.tools.aggregate_10x_matrices('tests/data/aggregate_test.csv', restrictions=[], attributes=['Version'],
    ...
    def test_multi_genome(self):
        sc.tools.aggregate_10x_matrices('tests/data/aggregate_multi_genome.csv', restrictions=[], attributes=None,
