...
def louvain(data, affinity='W', partition_type='RBC', resolution=1.3, random_state=0, class_label='louvain_labels'):
    start = time.time()
...
def leiden(data, affinity='W', partition_type='RBC', resolution=1.3, n_iter=-1, random_state=0,
    ...
    partition = leidenalg.find_partition(G, partition_type, seed=random_state, weights='weight',
        resolution_parameter=resolution, n_iterations=n_iter)
...
def approximate_louvain(data, rep_key, affinity='W', partition_type='RBC', resolution=1.3, n_clusters=30, n_init=20,
                        n_jobs=1, random_state=0, temp_folder=None, class_label='approx_louvain_labels'):
    start = time.time()
...
def approximate_leiden(data, rep_key, affinity='W', partition_type='RBC', resolution=1.3, n_clusters=30, n_init=20,
                       n_jobs=1, random_state=0, temp_folder=None, class_label='approx_leiden_labels'):
    start = time.time()
